...
namespace WB.EntrevistaABP.Migrations
{
    ...
    [Migration("20250826145323_MedioDeTransporteEnum")]
    partial class MedioDeTransporteEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PasajerosViajes", b =>
                {
                    ...
                    b.HasKey("PasajeroId", "ViajeId");

                    b.HasIndex("PasajeroId");

                    b.HasIndex("ViajeId");

                    b.ToTable("PasajerosViajes", (string)null);
                });
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Domain.Entidades.Pasajero", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Domain.Entidades.Viaje", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PasajerosViajes", b =>
                {
                    b.HasOne("WB.EntrevistaABP.Domain.Entidades.Pasajero", null)
                        .WithMany()
                        .HasForeignKey("PasajeroId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WB.EntrevistaABP.Domain.Entidades.Viaje", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Domain.Entidades.Pasajero", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("WB.EntrevistaABP.Domain.Entidades.Pasajero", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Domain.Entidades.Viaje", b =>
                {
                    b.HasOne("WB.EntrevistaABP.Domain.Entidades.Pasajero", "Coordinador")
                        .WithMany()
